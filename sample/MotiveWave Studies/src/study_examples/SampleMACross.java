...
public class SampleMACross extends Study
{
  ...
  public void initialize(Defaults defaults) {
    ...
    desc.exportValue(new ValueDescriptor(Signals.CROSS_ABOVE, Enums.ValueType.BOOLEAN, "Cross Above"));
    desc.exportValue(new ValueDescriptor(Signals.CROSS_BELOW, Enums.ValueType.BOOLEAN, "Cross Below"));
